...
#Region "Data Members"
        ...
        Private _salvageValuePercent As Double
        '/ <summary>
...
#Region "Property"
        ...
        Public Property SalvageValuePercent() As Double
            Get
                Return _salvageValuePercent
            End Get
            Set(ByVal Value As Double)
                _salvageValuePercent = Value
            End Set
        End Property
