...
Public Class frmImport
    ...
    Private Function ImportAsset(ByVal CompanyID As String, ByVal AssetItemID As String, ByVal CustodianID As String, ByVal LocID As String, ByVal CatID As String, ByVal AssetDesc As String, ByVal AssetDesc2 As String, ByVal RefNo As String, ByVal SupplierID As String, ByVal ItemQTY As Double, ByVal PONo As String, ByVal PurchaseDate As Date, ByVal ServiceDate As Date, ByVal BaseCost As Double, ByVal AdditionalCost As Double, ByVal CurrentBookValue As Double, ByVal AssetType As String, ByVal Spec1 As String, ByVal Spec2 As String, ByVal Spec3 As String, ByVal Spec4 As String, ByVal SerialNum As String, ByVal ModleNum As String, ByVal Comments As String) As Boolean
        'Add Asset Item
        Try
