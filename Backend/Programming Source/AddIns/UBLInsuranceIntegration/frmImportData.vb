...
Public Class frmImportData
    ...
    Private Function CheckColumnsMasterData(ByVal dt As DataTable) As Boolean
        ...
        If dt.Columns("Asset Code") Is Nothing Then
            Result = False
        End If
        ...
        If dt.Columns("Sub Category") Is Nothing Then
            Result = False
        End If
        ...
        If dt.Columns("Asset Description") Is Nothing Then
            Result = False
        End If
        If dt.Columns("Cost Center") Is Nothing Then
            Result = False
        End If
        ...
        If dt.Columns("Acquisition Date") Is Nothing Then
            Result = False
        End If
        If dt.Columns("Depreciation End Period") Is Nothing Then
            Result = False
        End If
        ...
        '    Result = False
        'End If
        If dt.Columns("WDV On End Period") Is Nothing Then
            Result = False
        End If
        If dt.Columns("Life in years") Is Nothing Then
            Result = False
        End If
        If dt.Columns("Salvage Value") Is Nothing Then
            Result = False
        End If
        ...
        ''    Result = False
        ''End If
        If dt.Columns("Branch") Is Nothing Then
            Result = False
        End If
        If dt.Columns("User") Is Nothing Then
            Result = False
        End If
        Return Result
    End Function
    ...
    Private Function ImportAssetCreation() As String
        ...
        Try
            ...
            For i As Integer = 0 To grdView.RowCount - 1
                'Import Company
                Dim CompanyID As String = ImportCompany("UBL")

                Dim CatID As String = 1
                If Not String.IsNullOrEmpty(grdView.GetRowCellValue(i, ("Asset Category")).ToString.Trim) Then
                    CatID = ImportCategory(grdView.GetRowCellValue(i, ("Asset Category")).ToString.Trim, grdView.GetRowCellValue(i, ("Sub Category")).ToString.Trim, grdView.GetRowCellValue(i, ("Life in years")).ToString.Trim, grdView.GetRowCellValue(i, ("Salvage Value")).ToString.Trim)
                End If
                'Import location.

                Dim LocID As String = 1
                If Not String.IsNullOrEmpty(grdView.GetRowCellValue(i, ("Branch")).ToString.Trim) Then
                    LocID = ImportLocation(grdView.GetRowCellValue(i, ("Branch")).ToString.Trim, "", "")
                End If
                'Import Employee

                Dim EmpID As String = 1
                If Not String.IsNullOrEmpty(grdView.GetRowCellValue(i, ("User")).ToString.Trim.Replace("'", "")) Then
                    EmpID = ImportEmp(grdView.GetRowCellValue(i, ("User")).ToString.Trim.Replace("'", ""), "")
                End If

                'Import(CostCenter)
                Dim CostCenterID As String = 1
                If Not String.IsNullOrEmpty(grdView.GetRowCellValue(i, ("Cost Center")).ToString.Trim) Then
                    If grdView.GetRowCellValue(i, ("Cost Center")).ToString.Trim.Length > 50 Then
                        CostCenterID = ImportCostCenter(grdView.GetRowCellValue(i, ("Cost Center")).ToString.Trim.Substring(0, 50).Replace("'", ""))
                    Else
                        CostCenterID = ImportCostCenter(grdView.GetRowCellValue(i, ("Cost Center")).ToString.Trim.Replace("'", ""))
                    End If
                End If
    ...
    Private Function ImportAsset(ByVal FocuseRowHandel As Integer, ByVal CatID As String, ByVal LocationID As String, ByVal CustodianID As String, ByVal CostCenterID As String, ByVal CompanyID As String, ByVal AstBrandID As String, ByRef dtAssets As DataTable, ByVal dtAssetDetails As DataTable, ByVal dtInvSch As DataTable, ByVal GLCode As String) As Boolean
        'Add Asset Item
        Try
            Dim ItemDesc As String = grdView.GetRowCellValue(FocuseRowHandel, ("Asset Description")).ToString.Trim
            Dim AssetRefNumber As String = grdView.GetRowCellValue(FocuseRowHandel, ("Asset Code")).ToString.Trim
            ...
            objattAssetDetails.AstNum = grdView.GetRowCellValue(FocuseRowHandel, ("Asset Num")).ToString.Trim
            ...
            Dim UsefulLife As Integer = grdView.GetRowCellValue(FocuseRowHandel, ("Life in years")).ToString.Trim
            ...
            Else
                ...
                If Not DateTime.TryParseExact(grdView.GetRowCellValue(FocuseRowHandel, ("Acquisition Date")).ToString.Trim, "MM/dd/yyyy", CultureInfo.CurrentCulture, DateTimeStyles.None, PDate) Then
                    PDate = Now.Date
                End If
                ...
                Dim DepDate As New DateTime(2017, 5, 31)
            
                If objBALAssetDetails.Insert_AssetDetails(objattAssetDetails, False) Then
                    objBALAssetDetails.Add_AstBooks(objattAssetDetails.PKeyCode, grdView.GetRowCellDisplayText(FocuseRowHandel, ("WDV On End Period")).ToString.Trim, objattAssetDetails.CompanyID, grdView.GetRowCellDisplayText(FocuseRowHandel, ("Salvage Value")).ToString.Trim, UsefulLife, 0, DepDate, False)
    ...
    Private Function ImportCategory(ByVal MainCat As String, ByVal SubCat As String, ByVal SalvageYear As Double, ByVal SalvageValue As Double) As String
