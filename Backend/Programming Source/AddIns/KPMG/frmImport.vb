...
Public Class frmImport
    ...
    Private Sub CreateAssetTempTable()
        ...
        dtImport.Columns.Add("Site", Type.GetType("System.String"))
        ...
        dtImport.Columns.Add("SubCat1", Type.GetType("System.String"))
        ...
        dtImport.Columns.Add("Brand", Type.GetType("System.String"))
                ...
                Try
                    ...
                    Else
                        ...
                        ElseIf ImportRow("MainCat").ToString.Length > 50 Then
                            ...
                            ImportRow("Status") = String.Concat(ImportRow("Status"), "MainCat > 50.")
                        End If
                        ImportRow("SubCat") = currentRow(4).ToString.Trim
                        If ImportRow("SubCat").ToString.Length > 50 Then
                            ImportRow("Status") = ImportRow("Status").ToString.Replace(SuccessMessage, "")
                            ImportRow("Status") = String.Concat(ImportRow("Status"), "SubCat > 50.")
                        End If

                        ImportRow("SubCat1") = currentRow(5).ToString.Trim
                        If ImportRow("SubCat1").ToString.Length > 50 Then
                            ImportRow("Status") = ImportRow("Status").ToString.Replace(SuccessMessage, "")
                            ImportRow("Status") = String.Concat(ImportRow("Status"), "SubCat1 > 50.")
                        End If

                        ImportRow("AssetDescription") = currentRow(6).ToString.Trim.Replace("'", " ")
                        ...
                        ImportRow("ItemQTY") = currentRow(7).ToString.Trim
                        Dim QTY As Double = 0
                        ...
                        ImportRow("SupplierID") = currentRow(14).ToString.Trim
                        If ImportRow("SupplierID").ToString.Length > 100 Then
                            ImportRow("Status") = ImportRow("Status").ToString.Replace(SuccessMessage, "")
                            ImportRow("Status") = String.Concat(ImportRow("Status"), "SupplierID > 100.")
                        End If


                        ImportRow("ServiceDate") = currentRow(15).ToString.Trim
                        Dim ServiceDate As Date = Now.Date
                        ...
                        ImportRow("Brand") = currentRow(19).ToString.Trim
                        If ImportRow("Brand").ToString.Length > 100 Then
                            ImportRow("Status") = ImportRow("Status").ToString.Replace(SuccessMessage, "")
                            ImportRow("Status") = String.Concat(ImportRow("Status"), "Brand > 100.")
                        End If
    ...
    Private Function ImportAssetData(ByVal SilentImport As Boolean, ByVal pb As DevExpress.XtraEditors.ProgressBarControl) As String
        ...
        For i As Integer = 0 To grdView.RowCount - 1
            ...
            If grdView.GetRowCellValue(i, ("Status")).ToString.Contains(SuccessMessage) And CBool(grdView.GetRowCellValue(i, ("Selection"))) = True Then
                ...
                'Import Category.
                Dim CatID As String = 1 'ImportCategory(grdView.GetRowCellValue(i, ("MainCat")), grdView.GetRowCellValue(i, ("SubCat")), grdView.GetRowCellValue(i, ("SubCat1")))
                'Import location.
                Dim loc As AssetLocation
                loc.City = grdView.GetRowCellValue(i, ("Site"))
                loc.Building = grdView.GetRowCellValue(i, ("Location"))

                loc.Floor = grdView.GetRowCellValue(i, ("MainCat"))
                ...
                Dim BrandID As String = ImportBrand(grdView.GetRowCellValue(i, ("Brand")))

                If ImportAsset(CompanyID, ItemCode, CustodianID, LocID, CatID, grdView.GetRowCellValue(i, ("AssetDescription")), "", grdView.GetRowCellValue(i, ("RefNum")), grdView.GetRowCellValue(i, ("SupplierID")), grdView.GetRowCellValue(i, ("ItemQTY")), "", grdView.GetRowCellValue(i, ("ServiceDate")), grdView.GetRowCellValue(i, ("ServiceDate")), 0, 0, 0, grdView.GetRowCellValue(i, ("AssetType")), grdView.GetRowCellValue(i, ("Spec1")), grdView.GetRowCellValue(i, ("Spec2")), grdView.GetRowCellValue(i, ("Spec3")), grdView.GetRowCellValue(i, ("Spec4")), grdView.GetRowCellValue(i, ("SerialNum")), grdView.GetRowCellValue(i, ("ModleNum")), grdView.GetRowCellValue(i, ("Comments")), BrandID) Then
    ...
    Private Function ImportAsset(ByVal CompanyID As String, ByVal AssetItemID As String, ByVal CustodianID As String, ByVal LocID As String, ByVal CatID As String, ByVal AssetDesc As String, ByVal AssetDesc2 As String, ByVal RefNo As String, ByVal SupplierID As String, ByVal ItemQTY As Double, ByVal PONo As String, ByVal PurchaseDate As Date, ByVal ServiceDate As Date, ByVal BaseCost As Double, ByVal AdditionalCost As Double, ByVal CurrentBookValue As Double, ByVal AssetType As String, ByVal Spec1 As String, ByVal Spec2 As String, ByVal Spec3 As String, ByVal Spec4 As String, ByVal SerialNum As String, ByVal ModleNum As String, ByVal Comments As String, ByVal Brand As String) As Boolean
        'Add Asset Item
        Try
            ...
            For i As Integer = 1 To ItemQTY
                ...
                objattAssetDetails.AstBrandID = Brand
