...
Public Class frmImportSettings
    ...
    Public Function SaveSettings() As Boolean
        Dim regKey As Microsoft.Win32.RegistryKey = My.Computer.Registry.CurrentUser.OpenSubKey("KPMGPlugin", True)
        Try
    ...
    Public Sub LoadSettings()
        ...
        Try
            If regKey Is Nothing Then
                My.Computer.Registry.CurrentUser.CreateSubKey("KPMGPlugin")
