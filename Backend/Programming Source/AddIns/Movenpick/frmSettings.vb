...
Public Class frmImportSettings
    ...
    Public Function SaveSettings() As Boolean
        Dim regKey As Microsoft.Win32.RegistryKey = My.Computer.Registry.CurrentUser.OpenSubKey("MovenpickPlugin", True)
        Try
    ...
    Public Sub LoadSettings()
        ...
        Try
            If regKey Is Nothing Then
                My.Computer.Registry.CurrentUser.CreateSubKey("MovenpickPlugin")
    ...
    Private Sub btnNotTechImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNotTechImport.Click
        ShowImportForm(txtOutAsset, frmImport.TFileImportType.NonTechAsset)
    End Sub
End Class