...
Public Class frmImport
            ...
            While Not MyReader.EndOfData
                ...
                Try
                    ...
                    Else
                        ...
                        ImportRow("MainCat") = currentRow(0).ToString.Trim
                        ...
                        ElseIf ImportRow("AssetDescription").ToString.Length > 200 Then
                            ImportRow("Status") = ImportRow("Status").ToString.Replace(SuccessMessage, "")
                            ImportRow("Status") = String.Concat(ImportRow("Status"), "AssetDescription > 200.")
                        End If
                        ...
                        ImportRow("CustodianID") = currentRow(4).ToString
    ...
    Private Function ImportAssetData(ByVal SilentImport As Boolean, ByVal pb As DevExpress.XtraEditors.ProgressBarControl) As String
        ...
        For i As Integer = 0 To grdView.RowCount - 1
            ...
            If grdView.GetRowCellValue(i, ("Status")).ToString.Contains(SuccessMessage) And CBool(grdView.GetRowCellValue(i, ("Selection"))) = True Then
                Dim CompanyID As String = grdView.GetRowCellValue(i, ("CompanyID"))
                'Import Category.
                ...
                Dim dtCust As DataTable = objCust.CheckID(objattCust)
                If dtCust.Rows.Count <= 0 Then
                    CustodianID = 999999 'Unknown
                End If

                Dim ItemCode As String = ImportItems(grdView.GetRowCellValue(i, ("AssetDescription")), CatID, False)

                If ImportAsset(CompanyID, ItemCode, CustodianID, LocID, CatID, grdView.GetRowCellValue(i, ("AssetDescription")), grdView.GetRowCellValue(i, ("OracleAssetNumber")), grdView.GetRowCellValue(i, ("SupplierID")), grdView.GetRowCellValue(i, ("ItemQTY")), grdView.GetRowCellValue(i, ("PONo")), grdView.GetRowCellValue(i, ("PurchaseDate")), grdView.GetRowCellValue(i, ("ServiceDate")), grdView.GetRowCellValue(i, ("BaseCost")), grdView.GetRowCellValue(i, ("AdditionalCost")), grdView.GetRowCellValue(i, ("CurrentBookValue"))) Then
    ...
    Private Function ImportAsset(ByVal CompanyID As String, ByVal AssetItemID As String, ByVal CustodianID As String, ByVal LocID As String, ByVal CatID As String, ByVal AssetDesc As String, ByVal OracleRefNumber As String, ByVal SupplierID As String, ByVal ItemQTY As Double, ByVal PONo As String, ByVal PurchaseDate As Date, ByVal ServiceDate As Date, ByVal BaseCost As Double, ByVal AdditionalCost As Double, ByVal CurrentBookValue As Double) As Boolean
        'Add Asset Item
        Try
