...
#End Region
    ...
    Public Function GetAssetsAdministartionGrid(ByVal objattAssetDetails As attAssetDetails) As IDbCommand
        ...
        strQuery.Append(" ,Companies.CompanyCode,Category.CatFullPath,Assetdetails.AstDesc as Assetdetailsdesc1")
        strQuery.Append(" ,AssetDetails.Purdate as 'Creation Date',CreatedBY,AssetDetails.SerailNo as 'Serial Number',CostCenter.CostNumber,'' as Plant,'' as Location,Location.LocationFullPath")
        strQuery.Append(" ,Custodian.CustodianName")
            ...
            Try
                ...
                For Each i As Integer In grdAssetsView.GetSelectedRows()
                    If GetGridRowCellValue(grdAssetsView, i, "itemcode").ToString <> "" Then '1 = "ItmCode"
                        ...
                        objattAst_Cust_history.HisDate = DateTime.Now
