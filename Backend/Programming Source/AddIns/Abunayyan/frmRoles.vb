...
#Region " -- Check Box Event--"
    ...
    Private Sub UnCheckAllCheckBoxs()
        SetCheckBoxValue(tabFile, False)
...
#End Region
    ...
    Private Function AddNewRecord() As Boolean
        Try
            ...
            objattRole.AssetsBooks = True
            objattRole.AssetItems = True
            objattRole.Units = False
            objattRole.Insurer = False
            objattRole.Supplier = chkAnonymousRemarks.Checked
            objattRole.PO = chkAssetCreation.Checked
