...
Public Class frmImportSettings
    ...
    Public Function SaveSettings() As Boolean
        Dim regKey As Microsoft.Win32.RegistryKey = My.Computer.Registry.CurrentUser.OpenSubKey("AbunayyanPlugin", True)
        Try
            If regKey IsNot Nothing Then
                regKey.SetValue("OutboundLocation", txtOutLocation.Text)
                regKey.SetValue("OutboundAssets", txtOutAsset.Text)
                regKey.SetValue("OutboundCostCenter", txtOutCostCenter.Text)
    ...
    Public Sub LoadSettings()
        ...
        Try
            If regKey Is Nothing Then
                My.Computer.Registry.CurrentUser.CreateSubKey("AbunayyanPlugin")

            Else
                txtOutLocation.Text = regKey.GetValue("OutboundLocation")
                txtOutAsset.Text = regKey.GetValue("OutboundAssets")
                txtOutCostCenter.Text = regKey.GetValue("OutboundCostCenter")
    ...
    Private Sub txtOutAsset_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtOutLocation.DoubleClick, txtOutEmployee.DoubleClick, txtOutCostCenter.DoubleClick, txtOutAsset.DoubleClick
        With dlgOpen
    ...
    Private Sub btnOpenDialogCostCenter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenDialogCostCenter.Click
        txtOutAsset_DoubleClick(txtOutCostCenter, e)
    End Sub
    ...
    Private Sub btnImportCostCenter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImportCostCenter.Click
        ShowImportForm(txtOutCostCenter, frmImport.TFileImportType.CostCenter)
    End Sub
    ...
    Public Sub ImportAll()
        ...
        Result &= frm.SilentImport(lblImportMessages, PBImport, txtOutCostCenter.Text, frmImport.TFileImportType.CostCenter)
    ...
    Private Sub LoadScheduleInfo()
        ...
        SetCheckStatus(chkSchCostCenter, txtTimeCostCenter)
    ...
    Private Sub chkSchCostCenter_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkSchCostCenter.CheckedChanged
        Schedule_CheckedChanged(sender, txtTimeCostCenter)
    End Sub
