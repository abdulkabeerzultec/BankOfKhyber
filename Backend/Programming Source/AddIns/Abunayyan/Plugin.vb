...
Public Class Plugin
    ...
    Private _frmDataProcess As frmDataProcessing
    ...
    Public Property frmDataProcess() As Form Implements AddInInterface.IAddIn.frmDataProcess
        Get
            If _frmDataProcess Is Nothing Then
                _frmDataProcess = New frmDataProcessing
                _frmDataProcess.IsDemokey = IsDemokey
                _frmDataProcess.RoleID = RoleID
            End If
    ...
    Public Sub btnUserRoles_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim frmUserRole As New frmRoles
        frmUserRole.MdiParent = MdiParent
        frmUserRole.WindowState = FormWindowState.Normal
        frmUserRole.StartPosition = FormStartPosition.CenterScreen
        frmUserRole.ShowInTaskbar = False
        frmUserRole.Show()
        frmUserRole.BringToFront()
    End Sub
