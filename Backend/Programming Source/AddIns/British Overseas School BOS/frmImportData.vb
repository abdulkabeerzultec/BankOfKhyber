...
Public Class frmImportData
    ...
    Private Function CheckColumnsMasterData(ByVal dt As DataTable) As Boolean
        ...
        If dt.Columns("Vendor") Is Nothing Then
            Result = False
        End If
    ...
    Private Function ImportAssetCreation() As String
        ...
        Try
            ...
            For i As Integer = 0 To grdView.RowCount - 1
                'Import Company
                Dim CompanyID As String = ImportCompany("BOS", "British Overseas School")

                Dim CatID As String = 1
                If Not String.IsNullOrEmpty(grdView.GetRowCellValue(i, ("Category")).ToString.Trim) Then
                    CatID = ImportCategory(grdView.GetRowCellValue(i, ("Category")).ToString.Trim, grdView.GetRowCellValue(i, ("Sub Category")).ToString.Trim, processYears(grdView.GetRowCellValue(i, ("Salvage Year")).ToString.Trim), "0")
                End If
                'Import location.

                Dim LocID As String = 1
                If Not String.IsNullOrEmpty(grdView.GetRowCellValue(i, ("Location")).ToString.Trim) Then
                ...
                If Not String.IsNullOrEmpty(grdView.GetRowCellValue(i, ("Vendor")).ToString.Trim) Then
                    SupplierID = ImportSupplier(grdView.GetRowCellValue(i, ("Vendor")).ToString.Trim)
                End If

                If ImportAsset(focusrowhandel, CatID, LocID, EmpID, CostCenterID, CompanyID, AstBrandID, dtAssets, dtAssetsDetails, dtInvSch, GLCode, SupplierID) Then
                    importedcount += 1
                End If
