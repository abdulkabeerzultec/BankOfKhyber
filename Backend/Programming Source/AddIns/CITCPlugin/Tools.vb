...
Module Tools
    ...
    Dim dlgProgress As DevExpress.Utils.WaitDialogForm

    Public Sub ShowProgressDialog(Optional ByVal Message1 As String = "", Optional ByVal Message2 As String = "")
        If String.IsNullOrEmpty(Message1) And String.IsNullOrEmpty(Message2) Then
            dlgProgress = New DevExpress.Utils.WaitDialogForm("Please Wait...", "Processing Request...")
        Else
            dlgProgress = New DevExpress.Utils.WaitDialogForm(Message1, Message2)
        End If
    End Sub
    ...
    Public Function DeleteTaskScheduler(ByVal ScheduleName As String, ByVal SystemPass As String) As Boolean
        ...
        End Try
    End Function
    Public Function CreateTaskScheduler(ByVal ScheduleName As String, ByVal SystemPass As String, ByVal RunHour As Integer, ByVal RunMinute As Integer, ByVal SelectedDays As TaskScheduler.DaysOfTheWeek) As Boolean
        ...
        Try
            ...
            t2.ApplicationName = Application.StartupPath & "\NMCSync.exe"
            t2.Parameters = "-" & ScheduleName
            t2.Comment = "NMC Synchronization Agent " & ScheduleName
            ...
            t2.Triggers.Add(New WeeklyTrigger(RunHour, RunMinute, SelectedDays, 1))
