...
Public Class frmImport
                ...
                For i As Integer = 0 To grdView.RowCount - 1
                    If grdView.GetRowCellValue(i, ("Message")).ToString.Contains(SuccessMessage) And CBool(grdView.GetRowCellValue(i, ("Selection"))) = True Then
                        ...
                        If Not String.IsNullOrEmpty(grdView.GetRowCellValue(i, "MAJOR_CATEGORY").ToString.Trim) Then
                            If grdView.GetRowCellValue(i, "CATEGORY3") IsNot Nothing Then
                                'CITC Customer
                                CatID = ImportCategory(grdView.GetRowCellValue(i, "MAJOR_CATEGORY"), grdView.GetRowCellValue(i, "MINOR_CATEGORY"), grdView.GetRowCellValue(i, "CAYEGORY_ID"), grdView.GetRowCellValue(i, "CATEGORY3"))
                            Else
                                'Nahdi Customer
                                CatID = ImportCategory(grdView.GetRowCellValue(i, "MAJOR_CATEGORY"), grdView.GetRowCellValue(i, "MINOR_CATEGORY"), grdView.GetRowCellValue(i, "CAYEGORY_ID"), String.Empty)
                            End If
                        End If
                        'Import location.
    ...
    Private Function ImportCategory(ByVal MainCat As String, ByVal SubCat As String, ByVal CategoryID As String, ByVal Category3 As String) As String
        ...
        If MainCatID = "" Then 'CatDesc not found
            ...
            If String.IsNullOrEmpty(SubCat) Or SubCat = "N/A" Then
                objattCategory.AstCatID = CategoryID
        ...
        Else
            ...
            If SubCatID = "" Then
                ...
                If objBALCategory.GetCatFullPath(CategoryID) = "0" Then
                    objattCategory.AstCatID = CategoryID
                    objattCategory.Code = CategoryID
                Else
        ...
        If String.IsNullOrEmpty(Category3) Or Category3 = "N/A" Then
            Return SubCatID
        Else
            Dim Category3ID As String = ""
            Category3ID = objBALCategory.GetCatIDByDesc(Category3, SubCatID)
            objattCategory = New attCategory
            If Category3ID = "" Then
                objattCategory.AstCatDesc = Category3
                If objBALCategory.GetCatFullPath(CategoryID) = "0" Then
                    objattCategory.AstCatID = CategoryID
                    objattCategory.Code = CategoryID
                Else
                    SubCatID = objBALCategory.GetChildCatID(MainCatID)
                    objattCategory.AstCatID = Category3ID
                    objattCategory.Code = Category3ID
                End If
