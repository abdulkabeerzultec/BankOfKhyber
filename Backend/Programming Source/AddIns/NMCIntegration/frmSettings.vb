...
Public Class frmNMCSettings
    ...
    Public Function SaveSettings() As Boolean
        Dim regKey As Microsoft.Win32.RegistryKey = My.Computer.Registry.CurrentUser.OpenSubKey("NahdiIntegration", True)
        Try
    ...
    Public Sub LoadSettings()
        ...
        Try
            If regKey Is Nothing Then
                My.Computer.Registry.CurrentUser.CreateSubKey("NahdiIntegration")
            Else
