...
Public Class frmABBSend
    ...
    Private Sub frmSend_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim objBalInteg As New BALABBIntegration
            cmbEvGroup.Properties.ValueMember = "EvaluationGroup1"
            cmbEvGroup.Properties.DisplayMember = "EvaluationGroup1"
            cmbEvGroup.Properties.DataSource = objBalInteg.GetEvaluationGroup1List()

            cmbClass.Properties.ValueMember = "AstCatID"
            cmbClass.Properties.DisplayMember = "AstCatDesc"
            cmbClass.Properties.DataSource = objBalInteg.GetAll_Classes()

            cmbBusinessArea.Properties.ValueMember = "BussinessArea"
            cmbBusinessArea.Properties.DisplayMember = "BussinessArea"
            cmbBusinessArea.Properties.DataSource = objBalInteg.GetBusinessAreaList()

            Dim objBALLocation As New BALLocation
            cmbLocation.Properties.ValueMember = "LocID"
            cmbLocation.Properties.DisplayMember = "LocDesc"
        ...
        Try
            ...
            For i As Int16 = 0 To grdView.RowCount - 1
                ...
                If CBool(grdView.GetRowCellValue(i, "Selection")) <> False Then
                    ...
                    If Not String.IsNullOrEmpty(cmbBusinessArea.Text) Then
                        BusArea = String.Format("'{0}'", cmbBusinessArea.Text.Replace(", ", "','"))
                    End If

                    Dim cat As String = String.Empty
                    If Not String.IsNullOrEmpty(cmbClass.Text) Then
                        cat = String.Format("'{0}'", cmbClass.Text.Replace(", ", "','"))
                    End If

                    Dim Loc As String = String.Empty
                    If Not String.IsNullOrEmpty(cmbLocation.Text) Then
                        Loc = String.Format("'{0}'", cmbLocation.Text.Replace(", ", "','"))
                    End If

                    Dim EvaluationGroup1 As String = String.Empty
                    If Not String.IsNullOrEmpty(cmbEvGroup.Text) Then
                        EvaluationGroup1 = String.Format("'{0}'", cmbEvGroup.Text.Replace(", ", "','"))
                    End If
                    objBALTransDataTemp.Export_Data_To_Temp(curDevID, Loc, True, Selection, BusArea, cat, EvaluationGroup1, String.Empty)
    ...
    Private Sub chkAsset_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkAsset.CheckedChanged
        ...
        grpAssetFilter.Visible = chkAsset.Checked
