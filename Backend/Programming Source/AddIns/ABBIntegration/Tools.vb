...
Module Tools
                ...
                If ComPID <> "" Then
                    ...
                    If EndRange <> 0 And StartRange <> 0 Then
                        ...
                        If EndRange < AstNum Then
                            ShowErrorMessage("Serial Range exceeded for this company, please define new range.")
                            objBALAssetsCoding.CloseRange(objattAssetsCoding)
                            Return ""
                        End If
                    Else
                        ShowErrorMessage("Assets Range for this company must be defined first.")
                        Return ""
                    End If
    ...
    Public Function CreateTaskScheduler(ByVal ScheduleName As String, ByVal SystemPass As String, ByVal RunHour As Integer, ByVal RunMinute As Integer) As Boolean
        ...
        Try
            ...
            t2.ApplicationName = Application.StartupPath & "\ABBSync.exe"
            t2.Parameters = "-" & ScheduleName
            t2.Comment = "ABB Synchronization Agent " & ScheduleName
