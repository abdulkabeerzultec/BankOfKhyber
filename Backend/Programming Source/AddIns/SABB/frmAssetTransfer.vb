...
#End Region
    ...
    Private Sub InitDTAssets()
        ...
        RitmAssets.PopupFormMinSize = New Drawing.Size(700, 400)
        RitmAssets.DataSource = objBALAssetDetails.GetAssetData_RepItemList
        RitmAssets.View.Columns("LocID").Visible = False
        RitmAssets.View.Columns("CustodianID").Visible = False

        RitmAssets.DisplayMember = "Barcode"
        RitmAssets.NullText = String.Empty
        RitmAssets.ValueMember = "Barcode"
    ...
    Private Function LoadGridItemInfo(ByVal obj As Object, ByVal FocRow As Integer) As Boolean
        Try
            ...
            If grvhandle <> DevExpress.XtraGrid.GridControl.InvalidRowHandle Then
                ...
                Return False
            Else
                Dim Rowhandle As Long = RitmAssets.View.LocateByValue(0, RitmAssets.View.Columns("Barcode"), obj)
                If Rowhandle <> DevExpress.XtraGrid.GridControl.InvalidRowHandle Then
                    grv.SetRowCellValue(FocRow, "Barcode", RitmAssets.View.GetRowCellValue(Rowhandle, "Barcode"))
                    grv.SetRowCellValue(FocRow, "AstID", RitmAssets.View.GetRowCellValue(Rowhandle, "AstID"))
                    grv.SetRowCellValue(FocRow, "AstNum", RitmAssets.View.GetRowCellValue(Rowhandle, "AstNum"))
                    grv.SetRowCellValue(FocRow, "AstDesc", RitmAssets.View.GetRowCellValue(Rowhandle, "AstDesc"))
                    grv.SetRowCellValue(FocRow, "AstCustodian", RitmAssets.View.GetRowCellValue(Rowhandle, "CustodianName"))
                    grv.SetRowCellValue(FocRow, "AstLocation", RitmAssets.View.GetRowCellValue(Rowhandle, "LocationFullPath"))
                    grv.SetRowCellValue(FocRow, "AstCategory", RitmAssets.View.GetRowCellValue(Rowhandle, "CatFullPath"))
                    grv.SetRowCellValue(FocRow, "CustodianID", RitmAssets.View.GetRowCellValue(Rowhandle, "CustodianID"))
                    grv.SetRowCellValue(FocRow, "LocID", RitmAssets.View.GetRowCellValue(Rowhandle, "LocID"))
                    Return True
                Else
                    Return False
                End If
    ...
    Private Sub UpdateExportServer(ByVal oldLoc As String, ByVal NewLoc As String, ByVal oldCust As String, ByVal NewCust As String, ByVal AstID As String)
        Try
            ...
            If AstID <> "" Then
                ...
                objAlHadaIntegration.Insert_AssetChange_ExportServer(objattAssetDetails1, Division, PrevDivision, NewLoc, oldLoc, Category, DateTime.Now.Date)
                objAlHadaIntegration.Update_AssetMaster_ExportServer(objattAssetDetails1.RefNo, Division, PrevDivision, NewLoc, oldLoc, DateTime.Now.Date)
            End If
        Catch ex As Exception
            GenericExceptionHandler(ex, WhoCalledMe)
        End Try
...
#End Region
    ...
    Private Sub LoadReport(ByVal rpt As rptAssetIssuance)
    ...
    Private Sub btnPrintReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintReport.Click
        If grv.RowCount > 0 And (Not String.IsNullOrEmpty(cmbLocation.SelectedText) Or Not String.IsNullOrEmpty(cmbCust.SelectedText)) Then
            Dim rpt As New rptAssetIssuance
            LoadReport(rpt)
            rpt.Print()
        End If
    End Sub
