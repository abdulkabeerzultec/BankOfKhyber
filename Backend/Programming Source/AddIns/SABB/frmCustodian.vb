...
#Region "Method"
    ...
    Private Sub Get_Cust()
        Try
            ...
            For intRow As Integer = 0 To grdView.RowCount - 1
                SetGridRowCellValue(grdView, intRow, "HierName", objBALOrgHier.HierName(GetGridRowCellValue(grdView, intRow, "HierCode").ToString))
            Next
        Catch ex As Exception
            GenericExceptionHandler(ex, WhoCalledMe)
        End Try
    ...
    Private Function AddNewRecord() As Boolean
        Try
            ...
            If String.IsNullOrEmpty(cmbDesg.SelectedValue) Then
            ...
            If valProvMain.Validate() Then
                ...
                If isEdit Then
                    If UpdateRecord() Then
                        ...
                        If String.IsNullOrEmpty(cmbDesg.SelectedValue) Then
                            SetGridRowCellValue(grdView, FocRow, "DesignationId", -1)
                        Else
