...
Public Class frmDOReceiving
    ...
    Public Delegate Sub UpUI(ByVal Rowupdated As Integer, ByVal flag As Boolean, ByRef send As frmDOTrans)
...
#Region "Method"
    Private Sub format_Grid()
        ...
        grdOrdersView.Columns(0).Caption = "DO Code"
        ...
        grdOrdersView.Columns(2).Caption = "DO Date"
        ...
        grdItemsView.Columns(0).Caption = "DO Item Code"
    ...
    End Sub
    Public Sub UpdateUIHandler(ByVal Rowupdation As Integer, ByVal flag As Boolean, ByRef sender As frmDOTrans)
        Try
