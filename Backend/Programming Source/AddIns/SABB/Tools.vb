...
Module Tools
    ...
    Enum TLanguage
        ...
        Urdu
    End Enum
    Public SelectedLanguage As TLanguage
    ...
    Private _NumericFormat As String = "N2"
    ...
    Public Sub GenericExceptionHandler(ByVal ex As Exception, _
                                       ByVal ErrSource As String, Optional ByVal showError As Boolean = True)
        If Not Directory.Exists(AppConfig.AppDataFolder & "\ErrorsReports\") Then
            Directory.CreateDirectory(AppConfig.AppDataFolder & "\ErrorsReports\")
        End If
    ...
    'Public Function ShowProgressBarDialog() As DevExpress.XtraEditors.ProgressBarControl
    '    'If dlgProgress Is Nothing Then
    '    '    dlgProgress = New DevExpress.Utils.WaitDialogForm(My.Resources.Strings.PleaseWait, My.Resources.Strings.ProcessingRequest, True)
    '    'Else
    '    '    dlgProgress.Refresh()
    '    '    dlgProgress.Show()
    '    'End If
    '    'Return dlgProgress.ProgBar
    'End Function

    Public Sub ShowProgressDialog()
        If dlgProgress Is Nothing Then
            dlgProgress = New DevExpress.Utils.WaitDialogForm(My.Resources.Strings.PleaseWait, My.Resources.Strings.ProcessingRequest)
        End If
    End Sub

    Public Sub CloseProgressDialog()
        If dlgProgress IsNot Nothing Then
            dlgProgress.Close()
            dlgProgress.Dispose()
            dlgProgress = Nothing
        End If
    ...
    Public Function IsNullOrEmptyValue(ByVal editValue As Object) As Boolean
        ...
        If TypeOf editValue Is String AndAlso String.IsNullOrEmpty(editValue) Then
            Return True
        End If
        If TypeOf editValue Is Guid AndAlso editValue = Guid.Empty Then
            Return True
        End If
