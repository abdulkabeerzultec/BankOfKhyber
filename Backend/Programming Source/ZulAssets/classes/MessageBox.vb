...
Public Class ZulMessageBox
    ...
    Public Shared Sub ShowMe(ByVal strKey As String)
        Dim rm As New ResourceManager("ZulAssets.Messages", Assembly.GetExecutingAssembly())
    ...
    Public Shared Sub ShowInfoMessage(ByVal Message As String)
        MessageBox.Show(Message, "ZulAssets", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
