...
#End Region
    ...
    Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
        FormController.objfrmRoles = Nothing
        Me.Dispose()
    End Sub
    ...
    Private Function AddNewRecord() As Boolean
        Try
            ...
            objattRole.Custom2 = chkAssetCreation.Checked
            objattRole.Custom3 = chkUpdateExistedAsset.Checked
            objattRole.Custom4 = chkDeleteAsset.Checked
            objattRole.Custom5 = chkDisposeAsset.Checked
    ...
    Private Sub RegisterIntegrationItems()
        Select Case IntegrationName
            Case IntegrationType.RetajIntegration
                chkImportFrmFile.Visible = True
                chkExportToFile.Visible = False
            Case IntegrationType.CMAIntegration
                chkDepMan.Visible = False
                chkInterCom.Visible = False
                chkAstTrans.Visible = False
                chkGroupHier.Visible = False
                chkCompGroup.Visible = False
                chkCompLevel.Visible = False
                chkCompanies.Visible = False
                chkDepPolicy.Visible = False
                chkCostCenter.Visible = False
                'Master Data 
                chkDesig.Visible = False
                chkAddress.Visible = False
                chkCustodian.Visible = False
        ...
        Else
            ...
            If ds Is Nothing = False Then
                If ds.Rows.Count > 0 Then
                    ...
                    chkAssetCreation.Checked = ds.Rows(0)("Custom2").ToString
                    chkUpdateExistedAsset.Checked = ds.Rows(0)("Custom3").ToString
                    chkDeleteAsset.Checked = ds.Rows(0)("Custom4").ToString
                    chkDisposeAsset.Checked = ds.Rows(0)("Custom5").ToString
